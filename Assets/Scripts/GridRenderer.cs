...
public class GridRenderer : MonoBehaviour
{
    ...
    void Start()
    {
        for (int x = 0; x <= GameConfiguration.worldWidth; x++)
        {
            ...
            gridLine.transform.localScale = new Vector3(GameConfiguration.gridLineThickness / GameConstants.planeScaleMultiplier, 1, (float)GameConfiguration.worldLength / 10);
        }
        ...
        for (int z = 0; z <= GameConfiguration.worldLength; z++)
        {
            ...
            gridLine.transform.localScale = new Vector3((float)GameConfiguration.worldWidth / 10, 1, GameConfiguration.gridLineThickness / GameConstants.planeScaleMultiplier);
        }
    }
}
